...
AAT_AMR_dens_dep <- function(times, init, parms){
  ...
  dPF.dt <- new.prop * CS -                                  # Adding new prophylactically treated cattle
    biterate * (prob.infection * fit.adj) * PF * VIr / N +   # Infection of resistant strain
  ...
  dVSf.dt <- prob.infection.v * biterate * (CIs/N) * VSf - 
  ...
  dVEs.dt <-  prob.infection.v * biterate * (CIs/N) * VSt + 
    prob.infection.v * biterate * (CTs/N) * VSt + 
    prob.infection.v * biterate * (PIs/N) * VSt + 
  ...
  dVEr.dt <-  prob.infection.v * biterate * (CIr/N) * VSt + 
    prob.infection.v * biterate * (CTr/N) * VSt + 
    prob.infection.v * biterate * (PIr/N) * VSt + 
    prob.infection.v * biterate * (PTr/N) * VSt + 
    prob.infection.v * biterate * (WIr/N) * VSt + 
